      ...
      <section className="book-venues">
        ...
        <div className="venue-list">
          <div className="card">
            ...
            <div className="card-content">
              <h3>Sports18</h3>
              <p>One of the largest turf in pune</p>
              <a href="#" className="btn">
                Read More
              </a>
            </div>
          ...
          <div className="card">
            ...
            <div className="card-content">
              <h3>Rapid Action Turf</h3>
              <p>Best turf for cricket and football</p>
              <a href="#" className="btn">
                Read More
              </a>
            </div>
          ...
          <div className="card">
            ...
            <div className="card-content">
              <h3>Super Kings</h3>
              <p>New and grand turf in pune and pcmc</p>
              <a href="#" className="btn">
                Read More
              </a>
            </div>
